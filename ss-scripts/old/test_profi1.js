...
//-------------------------------------------------------------
   ...
   if (arguments.length) {
    ...
    async function start(auth) {
      ...
      //let directions = ['Автокран', 'Автовышка', 'Экскаватор', 'Экскаватор', 'Манипулятор', 'Перетяжка', 'Бетон', 'ПГС'];
      let directions = ['Автокран'];
      ...
      spreadsheetId = '1aUftGAeMmV--Rudx7y60-F4IhgiNxLC2poWEbO41TfY';
