...
async function dev() {
  return new Promise(async(resolve, reject) => {
    ...
    async function start(auth) {
      ...
      let clientsData = await crud.readData(config.sid_2017_2.dev, range);
      ...
      let devResultData = await crud.readData(config.sid_2017_2.dev, range);
      ...
      try {
        ...
        await Promise.all([
            crud.updateData(sumContract, config.sid_2017_2.dev, range1),
            crud.updateData(normaFactHoursPrep, config.sid_2017_2.dev, range2),
            crud.updateData(endMonth, config.sid_2017_2.dev, range3)
        ])
