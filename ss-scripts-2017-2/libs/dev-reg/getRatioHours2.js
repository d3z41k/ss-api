                ...
                for (var mm = 0; mm < cutContractMonths[p].length; mm++) {
                  ...
                  if (cutContractMonths[p][mm] == months[m]) {
                    ...
                    if (lawt.name[n].trim() == MANAGER) {
                      ...
                      factHour += Math.round(worksHours.manager[m] / quantityProjects[currMonth] * 10000) / 10000;
                    } else if (lawt.name[n].trim() == MANAGER1) {
                      let currMonth = cutContractMonths[p][mm];
                      factHour += Math.round(worksHours.manager1[m] / quantityProjects[currMonth] * 10000) / 10000;
                    } else if (lawt.name[n].trim() == CTO) {
                      let currMonth = cutContractMonths[p][mm];
                      factHour += Math.round(worksHours.cto[m] / quantityProjects[currMonth] * 10000) / 10000;
                    } else {
