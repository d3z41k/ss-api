  ...
  return new Promise(async (resolve, reject) => {
    ...
    //= Update data =
     ...
     //  .then(async (results) => {console.log(results);})
      ...
      range = list.dev + '!' + colCosts + START + ':' + colDebt;
      ...
      ddsData = await crud.readData(config.sid_2017_2.dds, range);
      ...
      ************************************************************************/
      ...
      await Promise.all([
        crud.updateData(marginAll, config.sid_2017_2.dev, range1),
        crud.updateData(marginsAll, config.sid_2017_2.dev, range2),
      ])
      //  .then(async result => {console.log(result);})
        .catch(console.err);
